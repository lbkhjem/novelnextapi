...
const handler = async (req, res) => {
  ...
  const URL =
    "https://bestlightnovel.com/novel_list?type=latest&category=all&state=all&page=";
  ...
  getPageContent(URL + page).then($ => {
    ...
    var novels = {
        url: "https://novelonlinefree.info/novel_list?type=latest&category=all&state=all&page=" + page,
        page: page,
        data: data,
